export const modeleMail=function(username:string, msg:string):string{
  ...
  <!--[if !mso]>
    ...
    cellpadding="0" cellspacing="0" role="presentation">
      <tbody>
                    ...
                    <tr>
                      ...
                      align="center">
                        <div class="logo-left" align="left" id="emb-email-header">
                          ...
                          href="#">
                            <img style="display: block;height: auto;width: 100%;border: 0;max-width: 512px;"
                            src="https://image.ibb.co/nbQyGn/logo.png"
                            alt="LOGO" width="512">
                          </a>
                        </div>
        ...
        underline;transition: opacity 0.1s ease-in;color: #999;" >
